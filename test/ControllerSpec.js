...
describe("controller", function() {
  ...
  describe("routing", function() {
    ...
    it("should show active entries", function() {
      ...
      var todo = { title: "title", completed: false, id: 123456 };
      setUpModel([todo]);
    ...
    it("should show completed entries", function() {
      // TODO: write test
      var todo = { title: "title", completed: true, id: 123456 };
      setUpModel([todo]);
  ...
  describe("toggle all", function() {
    it("should toggle all todos to completed", function() {
      // TODO: write test
      var todo = [
        { title: "abcd", completed: false, id: 158162 },
        { title: "efgh", completed: false, id: 159862 }
      ];
    ...
    it("should update the view", function() {
      // TODO: write test
      var todo = { title: "abcd", completed: false, id: 158162 };
      setUpModel([todo]);
      subject.setView("");
      view.trigger("toggleAll", { completed: true });
